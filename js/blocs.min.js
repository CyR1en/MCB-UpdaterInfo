    ...
    $(".navbar-toggle").click(function(e) {
        ...
        if (a.parent().hasClass("nav-special"))
            if (e.stopPropagation(), $(this).hasClass("selected-nav")) $(".blocsapp-special-menu blocsnav").removeClass("open"), $(".selected-nav").removeClass("selected-nav"), setTimeout(function() {
                ...
                var l = i.attr("class").replace("navbar", "").replace("row", ""),
                    n = a.parent().attr("class").replace("navbar-collapse", "").replace("collapse", "");
                ($(".content-tint").length = -1) && $("body").append('<div class="content-tint"></div>'), o.insertBefore(".page-container").wrap('<div class="blocsapp-special-menu ' + l + '"><blocsnav class="' + n + '">'), $("blocsnav").prepend('<a class="close-special-menu animated fadeIn" style="animation-delay:0.5s;"><div class="close-icon"></div></a>'), t(), setTimeout(function() {
...
function scrollToTarget(t) {
    1 == t ? t = 0 : 2 == t ? t = $(document).height() : (t = $(t).offset().top, $(".sticky-nav").length && (t -= $(".sticky-nav").height())), $("html,body").animate({
        scrollTop: t
